...
<style>
  ...
  <body class="mt-5">
    ...
    <div class="col-lg-6 pt-5">
        <form action ="simpanpeserta.php" method = "post">
            <div class="form-group">
            <label for="exampleInputEmail1">Nama peserta  </label>
            <input type="text" name="namapeserta" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
             </div>
             <div class="form-group">
            <label for="exampleInputEmail1">TLP peserta</label>
            <input type="text" name="tlp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
             </div>
             <div class="form-group">
